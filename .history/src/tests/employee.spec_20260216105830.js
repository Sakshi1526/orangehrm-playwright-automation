...
test('test', async ({ page }) => {
    ...
    await page.getByRole('textbox', { name: 'First Name' }).fill('Saksh');
    await page.getByRole('textbox', { name: 'Middle Name' }).fill('Shas');
    await page.getByRole('textbox', { name: 'Last Name' }).fill('Shinde');
    await page.getByRole('textbox').nth(4).fill('193151');
    await page.locator('.oxd-switch-input').click();
    await page.getByRole('textbox').nth(5).fill('saksi123');
    await page.locator('input[type="password"]').first().fill('200sakshi');
    await page.locator('input[type="password"]').nth(1).fill('200sakshi');
